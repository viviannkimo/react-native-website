...
In this guide, we will explore how you can write your Native Modules using Swift.
...
We can achieve this by leveraging the [Adapter](https://refactoring.guru/design-patterns/adapter) design pattern, to connect the Swift Module with the Objective-C++ layer.
